...
// --- Tiptap UI ---
import { BLOCKQUOTE_SHORTCUT_KEY, useBlockquote, type UseBlockquoteConfig } from './use-blockquote';
...
export const BlockquoteShortcutBadge = ({ shortcutKeys = BLOCKQUOTE_SHORTCUT_KEY }: { shortcutKeys?: string }) => {
