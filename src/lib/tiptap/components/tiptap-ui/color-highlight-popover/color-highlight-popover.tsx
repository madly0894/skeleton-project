...
import { ColorHighlightButton, pickHighlightColorsByValue, useColorHighlight } from '../color-highlight-button';
...
export const ColorHighlightPopoverContent = ({
   ...
   return (
      <Card ref={containerRef} tabIndex={-1} style={isMobile ? { boxShadow: 'none', border: 0 } : {}}>
